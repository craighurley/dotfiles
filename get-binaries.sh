...
curl -Lo $download_dir/age-v1.0.0-rc.3-darwin-arm64.tar.gz https://github.com/FiloSottile/age/releases/download/v1.0.0-rc.3/age-v1.0.0-rc.3-darwin-arm64.tar.gz
